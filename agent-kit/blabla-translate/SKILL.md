...
2. Resume the assigned task. If the assignment requires a new task, read
   [task creation](../_blabla/references/api.md#post-translation-tasks): existing
   Locales use selected message ids; a configured new Locale uses the complete
   catalog scope. The server owns the task's basis.
3. Read one [task page](../_blabla/references/api.md#get-translation-tasksid),
   ...
   correcting a rejection.
4. Apply the [translation rules](../_blabla/references/api.md#translation-rules)
...
5. Submit up to 16 decisions through
   [task candidates](../_blabla/references/api.md#post-translation-tasksidcandidates).
...
[Locale Proposal lifecycle](../_blabla/references/api.md#new-locale-translation-task)
