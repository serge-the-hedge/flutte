...
HTTP Agent API for repository translations and directly authored Basic projects;
...
| [blabla-translate](blabla-translate/SKILL.md) | Author Basic source strings, translate task messages, or manage assigned languages |
